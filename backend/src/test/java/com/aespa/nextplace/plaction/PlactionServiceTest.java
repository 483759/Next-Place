...
public class PlactionServiceTest {
	...
	@Test
	void 플렉션_등록_성공() throws Exception{
	...
	@Test
	void 잘못된_스팟ID_플렉션_등록_실패() throws Exception{
		...
		//when
		try {
			plactionService.savePlaction(spotId, oauthUid, 100);
		} catch(Exception e) {
			ex = e;
		}
	...
	@Test
	void 중복_플렉션_등록_성공() throws Exception{
	...
	@Test
	void 시간제한으로_플렉션_등록_실패() throws Exception{
		...
		try{
			plactionService.savePlaction(spotId, oauthUid, score);
		}catch(Exception e) {
			ex = e;
		}
	...
	@Test
	void 도시별_플렉션_진행률_받기_성공() throws Exception{
	...
	@Test
	void 구군별_플렉션_진행률_받기_성공() throws Exception{
